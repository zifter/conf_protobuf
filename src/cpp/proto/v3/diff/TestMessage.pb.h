...
#ifndef PROTOBUF_v3_2fdiff_2fTestMessage_2eproto__INCLUDED
#define PROTOBUF_v3_2fdiff_2fTestMessage_2eproto__INCLUDED
...
class TestMessage_TestSection1 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:v3.diff.TestMessage.TestSection1) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:v3.diff.TestMessage.TestSection1)
 private:
  ...
  friend struct ::protobuf_v3_2fdiff_2fTestMessage_2eproto::TableStruct;
  friend void ::protobuf_v3_2fdiff_2fTestMessage_2eproto::InitDefaultsTestMessage_TestSection1Impl();
};
// -------------------------------------------------------------------

class TestMessage_TestSection2 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:v3.diff.TestMessage.TestSection2) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:v3.diff.TestMessage.TestSection2)
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_v3_2fdiff_2fTestMessage_2eproto::TableStruct;
  friend void ::protobuf_v3_2fdiff_2fTestMessage_2eproto::InitDefaultsTestMessage_TestSection2Impl();
};
// -------------------------------------------------------------------

class TestMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:v3.diff.TestMessage) */ {
 public:
  TestMessage();
  virtual ~TestMessage();
  ...
  const ::v3::diff::TestMessage_TestSection1& array_values(int index) const;
  ::v3::diff::TestMessage_TestSection1* mutable_array_values(int index);
  ::v3::diff::TestMessage_TestSection1* add_array_values();
  ::google::protobuf::RepeatedPtrField< ::v3::diff::TestMessage_TestSection1 >*
      mutable_array_values();
  const ::google::protobuf::RepeatedPtrField< ::v3::diff::TestMessage_TestSection1 >&
      array_values() const;
  ...
  const ::v3::diff::TestMessage_TestSection1& section1() const;
  ::v3::diff::TestMessage_TestSection1* release_section1();
  ::v3::diff::TestMessage_TestSection1* mutable_section1();
  void set_allocated_section1(::v3::diff::TestMessage_TestSection1* section1);

  // .v3.diff.TestMessage.TestSection2 section2 = 2;
  bool has_section2() const;
  void clear_section2();
  static const int kSection2FieldNumber = 2;
  const ::v3::diff::TestMessage_TestSection2& section2() const;
  ::v3::diff::TestMessage_TestSection2* release_section2();
  ::v3::diff::TestMessage_TestSection2* mutable_section2();
  void set_allocated_section2(::v3::diff::TestMessage_TestSection2* section2);
  ...
  // @@protoc_insertion_point(class_scope:v3.diff.TestMessage)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::v3::diff::TestMessage_TestSection1 > array_values_;
  ::v3::diff::TestMessage_TestSection1* section1_;
  ::v3::diff::TestMessage_TestSection2* section2_;
  double value6_;
  ::google::protobuf::uint32 value5_;
  mutable int _cached_size_;
  friend struct ::protobuf_v3_2fdiff_2fTestMessage_2eproto::TableStruct;
  friend void ::protobuf_v3_2fdiff_2fTestMessage_2eproto::InitDefaultsTestMessageImpl();
};
// ===================================================================
...
inline ::google::protobuf::uint32 TestMessage_TestSection1::value1() const {
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.TestSection1.value1)
  return value1_;
}
inline void TestMessage_TestSection1::set_value1(::google::protobuf::uint32 value) {
  
  value1_ = value;
  // @@protoc_insertion_point(field_set:v3.diff.TestMessage.TestSection1.value1)
}
...
inline ::google::protobuf::uint32 TestMessage_TestSection1::value2() const {
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.TestSection1.value2)
  return value2_;
}
inline void TestMessage_TestSection1::set_value2(::google::protobuf::uint32 value) {
  
  value2_ = value;
  // @@protoc_insertion_point(field_set:v3.diff.TestMessage.TestSection1.value2)
}
...
inline double TestMessage_TestSection2::value3() const {
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.TestSection2.value3)
  return value3_;
}
inline void TestMessage_TestSection2::set_value3(double value) {
  
  value3_ = value;
  // @@protoc_insertion_point(field_set:v3.diff.TestMessage.TestSection2.value3)
}
...
inline double TestMessage_TestSection2::value4() const {
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.TestSection2.value4)
  return value4_;
}
inline void TestMessage_TestSection2::set_value4(double value) {
  
  value4_ = value;
  // @@protoc_insertion_point(field_set:v3.diff.TestMessage.TestSection2.value4)
}
...
inline const ::v3::diff::TestMessage_TestSection1& TestMessage::section1() const {
  const ::v3::diff::TestMessage_TestSection1* p = section1_;
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.section1)
  return p != NULL ? *p : *reinterpret_cast<const ::v3::diff::TestMessage_TestSection1*>(
      &::v3::diff::_TestMessage_TestSection1_default_instance_);
}
inline ::v3::diff::TestMessage_TestSection1* TestMessage::release_section1() {
  // @@protoc_insertion_point(field_release:v3.diff.TestMessage.section1)
  
  ::v3::diff::TestMessage_TestSection1* temp = section1_;
  section1_ = NULL;
  return temp;
}
inline ::v3::diff::TestMessage_TestSection1* TestMessage::mutable_section1() {
  
  if (section1_ == NULL) {
    section1_ = new ::v3::diff::TestMessage_TestSection1;
  }
  // @@protoc_insertion_point(field_mutable:v3.diff.TestMessage.section1)
  return section1_;
}
inline void TestMessage::set_allocated_section1(::v3::diff::TestMessage_TestSection1* section1) {
  ...
  section1_ = section1;
  // @@protoc_insertion_point(field_set_allocated:v3.diff.TestMessage.section1)
}
...
inline const ::v3::diff::TestMessage_TestSection2& TestMessage::section2() const {
  const ::v3::diff::TestMessage_TestSection2* p = section2_;
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.section2)
  return p != NULL ? *p : *reinterpret_cast<const ::v3::diff::TestMessage_TestSection2*>(
      &::v3::diff::_TestMessage_TestSection2_default_instance_);
}
inline ::v3::diff::TestMessage_TestSection2* TestMessage::release_section2() {
  // @@protoc_insertion_point(field_release:v3.diff.TestMessage.section2)
  
  ::v3::diff::TestMessage_TestSection2* temp = section2_;
  section2_ = NULL;
  return temp;
}
inline ::v3::diff::TestMessage_TestSection2* TestMessage::mutable_section2() {
  
  if (section2_ == NULL) {
    section2_ = new ::v3::diff::TestMessage_TestSection2;
  }
  // @@protoc_insertion_point(field_mutable:v3.diff.TestMessage.section2)
  return section2_;
}
inline void TestMessage::set_allocated_section2(::v3::diff::TestMessage_TestSection2* section2) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete section2_;
  }
  ...
  section2_ = section2;
  // @@protoc_insertion_point(field_set_allocated:v3.diff.TestMessage.section2)
}
...
inline ::google::protobuf::uint32 TestMessage::value5() const {
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.value5)
  return value5_;
}
inline void TestMessage::set_value5(::google::protobuf::uint32 value) {
  
  value5_ = value;
  // @@protoc_insertion_point(field_set:v3.diff.TestMessage.value5)
}
...
inline double TestMessage::value6() const {
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.value6)
  return value6_;
}
inline void TestMessage::set_value6(double value) {
  
  value6_ = value;
  // @@protoc_insertion_point(field_set:v3.diff.TestMessage.value6)
}
...
inline const ::v3::diff::TestMessage_TestSection1& TestMessage::array_values(int index) const {
  // @@protoc_insertion_point(field_get:v3.diff.TestMessage.array_values)
  return array_values_.Get(index);
}
inline ::v3::diff::TestMessage_TestSection1* TestMessage::mutable_array_values(int index) {
  // @@protoc_insertion_point(field_mutable:v3.diff.TestMessage.array_values)
  return array_values_.Mutable(index);
}
inline ::v3::diff::TestMessage_TestSection1* TestMessage::add_array_values() {
  // @@protoc_insertion_point(field_add:v3.diff.TestMessage.array_values)
  return array_values_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::v3::diff::TestMessage_TestSection1 >*
TestMessage::mutable_array_values() {
  // @@protoc_insertion_point(field_mutable_list:v3.diff.TestMessage.array_values)
  return &array_values_;
}
inline const ::google::protobuf::RepeatedPtrField< ::v3::diff::TestMessage_TestSection1 >&
TestMessage::array_values() const {
  // @@protoc_insertion_point(field_list:v3.diff.TestMessage.array_values)
  return array_values_;
}
...
#endif  // PROTOBUF_v3_2fdiff_2fTestMessage_2eproto__INCLUDED
